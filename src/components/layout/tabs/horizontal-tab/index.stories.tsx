...
export default {
  component: Tabs,
  title: "Components/Layout/Tabs/HorizontalTabs",
  parameters: {
    componentSubtitle:
...
const Template: ComponentStory<typeof Tabs> = (args) => (
  <Tabs {...args}>
    <TabPanel title={"서비스"}>서비스탭</TabPanel>
    <TabPanel title={"기본정보"}>기본정보탭</TabPanel>
    <TabPanel title={"상세정보"}>상세정보탭</TabPanel>
    <TabPanel title={"부품"}>부품탭</TabPanel>
    <TabPanel title={"기기"}>기기탭</TabPanel>
  </Tabs>
);
