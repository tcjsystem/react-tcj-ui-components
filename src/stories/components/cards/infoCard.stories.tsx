...
import InfoCardRow from "../../../components/cards/contents/infoCardRow";
import InfoContents from "../../../components/cards/contents/infoCardRow";
export default {
  component: Card,
...
export const CardWithInfoContent = Template.bind({});

CardWithInfoContent.args = {
  title: "상세정보",
